...
public class BitInputStream extends InputStream {
	 ...
	 * 
	 * @return true if stream can be reset (it has been constructed appropriately
	 *         from a File).
	 */
	 ...
	 * @return the value read, only rightmost <code>howManyBits</code> are valid,
	 *         returns -1 if not enough bits left
	 */
